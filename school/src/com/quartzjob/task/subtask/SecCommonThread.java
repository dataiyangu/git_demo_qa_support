...
public class SecCommonThread implements Runnable {

	private static final Log log = LogFactory.getLog(SecCommonThread.class);
	...
	public SecCommonThread(String plat, String taskType, String taskName, String threadName, String profileName, String threadService,Long config){
		this.plat = plat;
	...
	public static SecCommonThread newInstanceThread(String plat, String taskType, String taskName, String threadName, String profileName, String threadService,Long config){
//		System.out.println("- create ->" + Thread.currentThread().getName());
		return new SecCommonThread(plat, taskType, taskName, threadName, profileName, threadService, config);
	}
...
//		Statement stmt = null;
//		log.info("SecCommonThread name ->" + Thread.currentThread().getName() + "--group->"
...
//            sqlend = 1L/0L;
//            log.info("SecCommonThread query name --" +name + "--config-->"+config);    
		} catch (Exception e) {
