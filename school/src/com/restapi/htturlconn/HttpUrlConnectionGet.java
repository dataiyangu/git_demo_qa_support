...
public class HttpUrlConnectionGet extends HttpServlet {
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp)
		...
		String validateURL="http://10.0.5.145:8101/strutsTest/Hello.do?userName=leo";
		validateURL = "http://10.0.5.79:9000/hotels";
//		validateURL="http://10.0.5.145:8770/strutsTest/Hello.do?userName=leo";
...
//		       dis = new DataInputStream(conn.getInputStream());  
			   ...
			   url = new URL("http://10.0.5.145:7001/school_j6/student/allStudent.action");
			   conn = (HttpURLConnection)url.openConnection();
			   conn.setConnectTimeout(5000);
			   conn.setRequestMethod("GET");
			   conn.connect();
			   
			   url = new URL("http://10.0.145:7001/school_j6/student/index.jsp");
			   conn = (HttpURLConnection)url.openConnection();
			   conn.setConnectTimeout(5000);
			   conn.setRequestMethod("GET");
			   conn.connect();
