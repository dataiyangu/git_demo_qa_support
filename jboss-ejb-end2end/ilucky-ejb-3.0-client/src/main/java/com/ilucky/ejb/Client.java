...
public class Client {
    ...
    private static HelloWorld doLookup() {
        ...
        try {
            ...
            System.out.println("context="+context.AUTHORITATIVE);
          //  System.out.println("context="+context.getNameParser(context.AUTHORITATIVE));
...
/**
 * ilucky-ejb-3.0-0.0.1-SNAPSHOT//HelloWorldBean!com.ilucky.ejb.service.HelloWorld
 * ilucky-ejb-3.0-0.0.1-SNAPSHOT/HelloWorldBean!com.ilucky.ejb.service.HelloWorld
 **/