...
<%-- 	location.href = "<%=request.getContextPath() %>/student/delStudentById.action?student.sid="+sid; --%>
  ...
  <body>
     <H1>HttpClient-3.1</H1>
  	 <form id="student" action="${pageContext.request.contextPath}/student/restclient31.action" method="post" >
     	...
     	<input type="submit" value="testHttpClient-3.1"/>
     	<span id="dbxl" ></span>
     </form>
     ${msg}
  </body>
